...
const Ledger = () => {
  ...
  const [endDate, setEndDate] = useState(new Date('2025-01-23'));
  const [showStartPicker, setShowStartPicker] = useState(false);
  const [showEndPicker, setShowEndPicker] = useState(false);
const totalGrossProfit = ledgerData.reduce((sum, item) => sum + item.profit, 0);
                ...
                <Card.Content>
                  ...
                  <View style={styles.priceContainer}>
                    ...
                    <View style={styles.priceItem}>
                      ...
                      <Text style={styles.profitPrice}>{formatCurrency(item.profit)}</Text>
                    </View>
                  </View>
                </Card.Content>
              </Card>
